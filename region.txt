...
In places with low bandwidth or spotty internet, the code avoids cloud-heavy APIs


Instead, it may use lightweight local models or add caching and batching to reduce data usage
